...
public class LoanAccount {
    ...
    LoanAccount(double principal,double annualInterestRate,int months){
    ...
    public String toString(){
        ...
        "Car Loan with:%nPrincipal: $%.2f%nAnnual Interest Rate: %.2f%%%nTerm of Loan in Months: %s%nMonthly Payment: $%.2f",principal,annualInterestRate,months,calculateMonthlyPayment()
        );
    }
